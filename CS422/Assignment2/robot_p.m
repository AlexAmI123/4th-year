...
% 3 Link Polar RPP Robot, Set alpha, theta, L and D for each link
theta=[angle 0 0];
alpha=[0 -90 0];
 L=[0 0 0];
 D=[0 height radius];
...
for(i=1:3+1),
line1=sprintf('%.0f',i);
text(v(1,i),v(2,i),{line1},'Color','Blue','FontName','Times','Fontsize',8,'HorizontalAlignment
...
for(i=1:3+1),
line1=sprintf('%.0f',i);
text(v(2,i),v(3,i),{line1},'Color','Blue','FontName','Times','Fontsize',8,'HorizontalAlignment
','center','VerticalAlignment','bottom');
end;
...
for(i=1:3+1),
line1=sprintf('%.0f',i);
text(v(1,i),v(3,i),{line1},'Color','Blue','FontName','Times','Fontsize',8,'HorizontalAlignment
','center','VerticalAlignment','bottom');
end;
