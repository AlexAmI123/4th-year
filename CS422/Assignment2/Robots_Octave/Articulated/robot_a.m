...
angle1=get(hui(1),'value'); 
angle2=get(hui(2),'value');
angle3=get(hui(3),'value');
...
set(a,'string',strcat('Angle1:',num2str(angle1)));
b=uicontrol('style','text','position',[110 50 80 20]);
set(b,'string',strcat('Angle2:',num2str(angle2)));
c=uicontrol('style','text','position',[220 50 80 20]);
set(c,'string',strcat('Angle3:',num2str(angle3)));
