...
def colour_update(msg):
    ...
    # Check if we are on the red square and if so then set
    ...
    # Construct a random Twist message that has a 50/50 chance of
    # being a forward motion and a rotion message
