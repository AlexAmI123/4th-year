...
# ╔═╡ adc1b657-ed35-49a4-9415-5cd6879b83fe
md"""# 20429324, CS401 - ML & NN, Assignment 5"""
...
begin
	ids         = sort(rand(1:10000, 20))
	rand_test   = test_x[:,:,:,ids] |> gpu
	rand_truth  = test_y[ids]
	model_res   = m3(rand_test)
end

# ╔═╡ eaf2bc86-23b9-489b-9751-e78bceea5a57
@bind img_index Slider(1:1:size(ids, 1), default = 1)

# ╔═╡ e5101ec8-681c-43e3-b9af-2adb39b7b978
plot(
	image(rand_test[:,:,:,img_index]),
	title =
		"Ground Truth: $(uppercase(labels[rand_truth[img_index] + 1]))\nPrediction: $(uppercase(labels[findmax(model_res[:, img_index])[2]]))"
)
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "b1fd076a00efb9fda6d58caaf8f03ba23537a240"
